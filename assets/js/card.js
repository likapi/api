const APIdata = [
{
  index: 0,
  headline: "Blockchain",
  link: "?service=coinbase&currency=eur&crypto=btc" },
...
class Slide extends React.Component {
  ...
  render() {
    const { link, headline, index } = this.props.slide;
    ...
    return /*#__PURE__*/(
      ...
      React.createElement("img", {
        ...
        alt: headline,
        src: "https://source.unsplash.com/random?"+headline+"",
      ...
      React.createElement("button", { className: "slide__action btn", onClick: () => {window.location=link} }, "Rechercher"))));
...
ReactDOM.render( /*#__PURE__*/React.createElement(Slider, { heading: "Example Slider", slides: APIdata }), document.getElementById('app'));